...
export function NotionConnect({ connected }: Props) {
      ...
      {connected ? (
        <div className="flex items-center justify-between rounded-md border border-neutral-200 p-3 dark:border-neutral-800">
          <p className="text-sm">
            ...
            <span className="text-neutral-500">— el agente puede leer y editar las páginas que compartiste.</span>
          </p>
          <button
        ...
        <div className="space-y-2">
          <p className="text-sm text-neutral-500">
            Conecta tu cuenta de Notion para que el agente pueda buscar, leer, crear páginas y añadir contenido.
            Durante la autorización, recuerda seleccionar las páginas o bases de datos que quieras compartir — el
            agente sólo podrá ver lo que marques.
          </p>
          <button
